 ...
 * @author andre
 */
public class ControladorEnlaceRegistro extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (convocatoria.getEstado().equalsIgnoreCase("Cerrado")) {
                    response.sendRedirect("Views/VistaFormularioRegistro.jsp");
                } else {
                    session.setAttribute("MensajeError", "Se ha terminado el plazo de registro. Disculpe las molestias.");
