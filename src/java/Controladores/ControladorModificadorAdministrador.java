 ...
 * @author andre
 */
public class ControladorModificadorAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Administrador administrador = new Administrador(nif, nombre, apellidos, telefono, fechaNac, mail, sexo, contrasena);
            ...
            try {
                ...
                new Operaciones().updatePersona(nif, administrador, conexion);
                new Operaciones().updateAdministrador(nif, administrador, conexion);
