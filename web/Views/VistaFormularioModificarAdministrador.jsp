<%-- 
    Document   : VistaFormularioModificarAdministrador
    Created on : 12-nov-2020, 0:54:13
    Author     : andre
--%>
...
<html lang="es">
    ...
    <body class="bg-dark">
        <%
            Administrador administrador = (Administrador) session.getAttribute("Persona");
            Direccion direccion = (Direccion) session.getAttribute("Direccion");
        %>
        <div class="container vh-100 d-flex align-items-center justify-content-center">
            <div class="card p-5 overflow-auto">
                <form action="../ControladorModificadorAdministrador">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="nif" id="nif" maxlength="9" minlength="9" readonly value="<%=administrador.getDni()%>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="contrasena">Contraseña</label>
                            <input type="password" class="form-control" id="contrasena" name="contrasena" required value="<%=administrador.getPassword()%>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" class="form-control" name="nombre" id="nombre" required value="<%=administrador.getNombre()%>">
                    </div>
                    <div class="form-group">
                        <label for="apellidos">Apellidos</label>
                        <input type="text" class="form-control" name="apellidos" id="apellidos" required value="<%=administrador.getApellidos()%>">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="email" name="email" aria-label="Username" aria-describedby="basic-addon1"value="<%=administrador.getEmail()%>">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="telefono" name="telefono" minlength="9" maxlength="9" aria-label="Username" aria-describedby="basic-addon1" value="<%=administrador.getTelefono().substring(3, 12)%>">
                            </div>
                        </div> 
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" name="fechanac" id="fechanac" placeholder="" required value="<%=administrador.getFecha_nac()%>">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <a class="btn btn-danger" href="VistaMenuAdminPerfil.jsp" role="button">Cancelar</a>
